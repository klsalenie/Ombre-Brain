...
class BucketManager:
    ...
    def _record_v3_bucket_event_safe(
        self,
        action: str,
        bucket_id: str,
        bucket_type: str,
        ...
        try:
            ...
            logger.warning(f"v2.4.0 legacy runtime record failed for {action}:{bucket_id}: {e}")
...
=======
        ...
        self._record_v3_bucket_event_safe(
            "create",
            bucket_id,
            str(metadata.get("type", bucket_type)),
            linked_content,
            dict(metadata),
        )
